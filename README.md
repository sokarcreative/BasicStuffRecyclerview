...
============
Because on every project I need my own library (relevant library to me) and I'm bored because it was'nt designed the way it should be, I decided to finally maintain it. Sry for people using it before but breaking changes is mandatory :/
